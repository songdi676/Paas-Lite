package com.songdi.paas.auth.server.controller;
...
public class AuthController {
    ...
    public ObjectRestResponse<String>
        createAuthenticationToken(@RequestBody JwtAuthenticationRequest authenticationRequest) throws Exception {
