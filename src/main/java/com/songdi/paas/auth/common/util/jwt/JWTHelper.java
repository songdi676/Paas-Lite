package com.songdi.paas.auth.common.util.jwt;

import org.joda.time.DateTime;

import com.songdi.paas.auth.common.constatns.CommonConstants;
...
public class JWTHelper {
    ...
    public static String generateToken(IJWTInfo jwtInfo, String priKeyPath, int expire) throws Exception {
        String compactJws =
            Jwts.builder().setSubject(jwtInfo.getUniqueName()).claim(CommonConstants.JWT_KEY_USER_ID, jwtInfo.getId())
