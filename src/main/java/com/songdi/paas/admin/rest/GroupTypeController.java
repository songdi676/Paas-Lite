...
import com.songdi.paas.admin.biz.GroupTypeBiz;
...
public class GroupTypeController extends BaseController<GroupTypeBiz, GroupType> {
    ...
    // @ResponseBody
    // public TableResultResponse<Object> page(@RequestParam(defaultValue = "10") int limit, @RequestParam(defaultValue
    // = "1")int page, String name){
