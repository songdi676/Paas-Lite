...
import com.songdi.paas.admin.constant.AdminCommonConstant;
import com.songdi.paas.admin.entity.Group;
import com.songdi.paas.admin.entity.Menu;
import com.songdi.paas.admin.entity.ResourceAuthority;
import com.songdi.paas.admin.mapper.GroupMapper;
...
import com.songdi.paas.admin.vo.AuthorityMenuTree;
import com.songdi.paas.admin.vo.GroupUsers;
...
public class GroupBiz extends BaseBiz<GroupMapper, Group> {
    ...
    public void modifyAuthorityMenu(int groupId, String[] menus) {
        resourceAuthorityMapper.deleteByAuthorityIdAndResourceType(groupId + "",
            AdminCommonConstant.RESOURCE_TYPE_MENU);
        ...
        for (String menuId : relationMenus) {
            authority =
                new ResourceAuthority(AdminCommonConstant.AUTHORITY_TYPE_GROUP, AdminCommonConstant.RESOURCE_TYPE_MENU);
    ...
    public void modifyAuthorityElement(int groupId, int menuId, int elementId) {
        ResourceAuthority authority =
            new ResourceAuthority(AdminCommonConstant.AUTHORITY_TYPE_GROUP, AdminCommonConstant.RESOURCE_TYPE_BTN);
        authority.setAuthorityId(groupId + "");
    ...
    public List<AuthorityMenuTree> getAuthorityMenu(int groupId) {
        List<Menu> menus =
            menuMapper.selectMenuByAuthorityId(String.valueOf(groupId), AdminCommonConstant.AUTHORITY_TYPE_GROUP);
