  ...
  <div class="app-container calendar-list-container">
    ...
    >
      ...
      <el-table-column fixed="right" align="center" label="操作" width="150">
        <template scope="scope">
          <el-button
            v-if="menuManager_btn_element_edit"
            size="small"
            type="success"
            @click="handleUpdate(scope.row)"
          >编辑</el-button>
          <el-button
            v-if="menuManager_btn_element_del"
            size="small"
            type="danger"
...
<script>
import { page, addObj, getObj, delObj, putObj } from "api/admin/element/index";
...
export default {
  ...
  created() {
    this.getList();
    this.menuManager_btn_element_add = this.elements[
      "menuManager:btn_element_add"
    ];
    this.menuManager_btn_element_del = this.elements[
      "menuManager:btn_element_del"
    ];
    this.menuManager_btn_element_edit = this.elements[
      "menuManager:btn_element_edit"
    ];
  },
  computed: {
    ...mapGetters(["elements"])
